...
Widget1=MyWidget(scr,-100,15,280,1000,1000)  #x轴偏移量，y轴偏移量，宽度，高度，上升时间，下降时间
time.sleep(0.2)
Widget2=MyWidget(scr,-75,15,280,1000,1000)
time.sleep(0.2)
Widget3=MyWidget(scr,-50,15,280,1000,1000)
time.sleep(0.2)
Widget4=MyWidget(scr,-25,15,280,1000,1000)
time.sleep(0.2)
Widget5=MyWidget(scr,0,15,280,1000,1000)
time.sleep(0.2)
Widget6=MyWidget(scr,25,15,280,1000,1000)
time.sleep(0.2)
Widget7=MyWidget(scr,50,15,280,1000,1000)
time.sleep(0.2)
Widget8=MyWidget(scr,75,15,280,1000,1000)
time.sleep(0.2)
Widget9=MyWidget(scr,100,15,280,1000,1000)
