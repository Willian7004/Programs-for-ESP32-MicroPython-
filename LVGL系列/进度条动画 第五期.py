...
# 2. 封装要显示的组件
class MyWidget():
    def __init__(self, scr,x,y,w,h,t1,t2): #x轴偏移量，宽度，高度，上升时间，下降时间
        # 1. 创建进度条对象
        self.bar = lv.bar(scr)
...
Widget1=MyWidget(scr,-80,-25,25,130,1000,1000)  #x轴偏移量，y轴偏移量，宽度，高度，上升时间，下降时间
time.sleep(0.2)
Widget2=MyWidget(scr,-40,-25,25,130,1000,1000)
time.sleep(0.2)
Widget3=MyWidget(scr,0,-25,25,130,1000,1000)
time.sleep(0.2)
Widget4=MyWidget(scr,40,-25,25,130,1000,1000)
time.sleep(0.2)
Widget5=MyWidget(scr,80,-25,25,130,1000,1000)
time.sleep(0.2)
Widget6=MyWidget(scr,-80,-170,25,130,1000,1000)  
time.sleep(0.2)
Widget7=MyWidget(scr,-40,-170,25,130,1000,1000)
time.sleep(0.2)
Widget8=MyWidget(scr,0,-170,25,130,1000,1000)
time.sleep(0.2)
Widget9=MyWidget(scr,40,-170,25,130,1000,1000)
time.sleep(0.2)
Widget10=MyWidget(scr,80,-170,25,130,1000,1000)
