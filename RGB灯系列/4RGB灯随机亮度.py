...
led9=PWM(Pin(19),freq=10000,duty=0)
led10=PWM(Pin(21),freq=10000,duty=0)
led11=PWM(Pin(3),freq=10000,duty=0)
led12=PWM(Pin(1),freq=10000,duty=0)
...
if __name__=="__main__":
   while True:
        ...
        duty_value9=random.randint(0,1023)
        duty_value10=random.randint(0,1023)
        duty_value11=random.randint(0,1023)
        duty_value12=random.randint(0,1023)
        ...
        time.sleep_ms(50)
        led9.duty(duty_value9)
        time.sleep_ms(50)
        led10.duty(duty_value10)
        time.sleep_ms(50)
        led11.duty(duty_value11)
        time.sleep_ms(50)
        led12.duty(duty_value12)
        time.sleep_ms(50)
